...
const Home1 = () => {
    ...
    useEffect(() => {
        ...
        if(context) {
            let w = context.canvas.height
            let h = context.canvas.width 
    ...
    return(
        <div style={{paddingLeft: '5vw', paddingRight: '5vw'}}>
            <TransformWrapper>
                <TransformComponent>
                    <canvas ref={canvasRef} style={{maxHeight: '90vh', maxWidth: '90vw'}} width={window.innerHeight * 5 * hw} height={window.innerHeight * 5}/>
                </TransformComponent>
            </TransformWrapper>
        </div>
    )
