...
const defaultState = {gameType: 0, countColors: 0, fieldType: 0, startCellsType: 0, fieldSize: 0, botLevel: 0, seed: undefined}
...
export default createContainer(new NewGameStore().useNeGame)